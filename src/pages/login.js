...
const Login = () => {
    ...
    return(
        ...
        <Navbar/>
            <div className="container mx-auto d-block div-center text-center h-75">
                <div class="row mx-auto p-5 align-items-center">
                <h2>Log In</h2>
                <form>
                    <div class="form-group p-1">
                        <input id="username" class="w-50 p-1 rounded border border-black" placeholder="Username or Password" type="text"/>
                    </div>
                ...
                <p class="text-muted">Belum punya akun? <a href="/signup">Daftar</a></p>
                </div>
            </div>
        <Footer/>
        </div>
